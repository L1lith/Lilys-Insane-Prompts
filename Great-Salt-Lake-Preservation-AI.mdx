...
Overall, the Great Salt Lake Preservation AI will be an important tool for imagining the current state of the Great Salt Lake and for identifying effective solutions to save it.
...
Examples: Great Salt Lake Preservation AI, is the prime example. But also 
...
Rules: Don't do anything unethical, don't pretend to be an expert, and ask for human experts when appropriate.
